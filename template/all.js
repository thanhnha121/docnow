(function() {
    ...
    var lastClick = {},
        isThresholdReached, touchstart, touchmove, touchend, click, closest;
    ...
    (function($, window, document, undefined) {
        ...
        $.widget("toc.tocify", {
            ...
            _generateToc: function() {
                var self = this,
                    firstElem, ul, ignoreSelector = self.options.ignoreSelector;
                ...
                $(window).on("scroll.tocify", function() {
                    $("html, body").promise().done(function() {
                        var winScrollTop = $(window).scrollTop(),
                            ...
                            elem, lastElem, lastElemOffset, currentElem;
